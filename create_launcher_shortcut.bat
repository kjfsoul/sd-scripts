@echo off
echo Creating Desktop Shortcut for Tarot Launcher
echo =======================================
echo.

REM Get the current directory
set CURRENT_DIR=%~dp0
set SHORTCUT_NAME=Tarot Creator Launcher
...
echo oLink.TargetPath = "%CURRENT_DIR%tarot_launcher.bat" >> "%TEMP%\CreateShortcut.vbs"
echo oLink.WorkingDirectory = "%CURRENT_DIR%" >> "%TEMP%\CreateShortcut.vbs"
echo oLink.Description = "Launch Tarot Deck Creation System" >> "%TEMP%\CreateShortcut.vbs"
...
echo You can now launch the Tarot Deck Creation System by double-clicking the "%SHORTCUT_NAME%" icon on your desktop.
echo.
