@echo off
echo Creating Desktop Shortcut for One-Click Tarot System
echo ===============================================
echo.

REM Get the current directory
set CURRENT_DIR=%~dp0
set SHORTCUT_NAME=One-Click Tarot Creator
...
echo oLink.TargetPath = "%CURRENT_DIR%one_click_tarot.bat" >> "%TEMP%\CreateShortcut.vbs"
echo oLink.WorkingDirectory = "%CURRENT_DIR%" >> "%TEMP%\CreateShortcut.vbs"
echo oLink.Description = "Start Tarot Deck Creation System with One Click" >> "%TEMP%\CreateShortcut.vbs"
