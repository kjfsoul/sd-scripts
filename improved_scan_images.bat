@echo off
echo Improved Reference Image Scanner
echo =============================
echo.
...
echo.
echo This improved scanner includes:
echo - Increased timeout (3 minutes per image)
echo - Automatic retries with exponential backoff
echo - Image resizing for large files
echo - Batch processing to avoid overloading the API
echo - Progress tracking and detailed error reporting
echo.
