@echo off
echo Simple Modification of webui-user.bat
echo ==================================
...
echo.
echo Current content of webui-user.bat:
...
echo.
echo New content of webui-user.bat:
type "%SD_PATH%\webui-user.bat"

echo.
echo webui-user.bat has been modified to enable the API.
echo.
echo Now you need to start Automatic1111 using your normal method.
