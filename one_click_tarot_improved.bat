...
echo.
echo IMPORTANT: Follow this recommended workflow:
echo  a. Scan reference images (Option 1)
echo  b. Analyze deck style (Option 2)
echo  c. Enhance deck style (Option 3)
echo  d. Setup tarot reference database (Option 4)
echo  e. Generate style guide (Option 5)
echo  f. Refine prompts for cards (Option 6)
echo  g. Generate initial samples (Option 9)
echo  h. Review and provide feedback (Option 12)
echo  i. Generate full deck (Option 10 or 11)
echo  j. Add borders and elements (Option 16)
echo.
