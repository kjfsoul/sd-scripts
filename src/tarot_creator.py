...
class TarotCreator:
    ...
    def generate_image(self, prompt, filename, output_dir=DEFAULT_OUTPUT_DIR, params=None):
    ...
    def save_prompt(self, card_name, prompt, prompt_dir=DEFAULT_PROMPTS_DIR):
    ...
    def generate_initial_cards(self):
        ...
        for card in initial_cards:
            ...
            # Create prompts for this card
            base_prompt = f"{card_name} tarot card, {style}"
